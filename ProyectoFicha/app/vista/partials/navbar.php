...
<nav class="app-header navbar navbar-expand bg-white shadow-sm border-bottom-success">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto align-items-center">
            ...
            <!-- Indicador de Estado del PBX (solo operadores) -->
            <?php if (isset($_SESSION['user_rol_id']) && (int)$_SESSION['user_rol_id'] === 2): ?>
                <li class="nav-item me-3" id="pbx-status-container">
                    <span class="nav-link p-0 d-flex align-items-center" id="pbx-status-tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="PBX: Inicializando...">
                        <i id="pbx-status-indicator" class="bi bi-telephone-fill text-secondary" style="font-size: 1.25rem; transition: color 0.3s ease;"></i>
                    </span>
                </li>
            <?php endif; ?>
