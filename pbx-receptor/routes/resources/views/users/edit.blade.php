    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-sm border p-6 max-w-2xl mx-auto">
            <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">Nueva Contraseña (dejar en blanco para no cambiar)</label>
                ...
                <div class="pt-4 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-blue-600 text-white font-bold uppercase tracking-widest text-xs rounded-md hover:bg-blue-700 transition shadow-lg shadow-blue-200">Actualizar</button>
                </div>
            </form>
        </div>
    </div>
